...
import * as RefreshService from '../../services/auth/refresh.service.js'
import * as EmailService from '../../services/auth/verify-email.service.js'
...
export const resetPasswordController = async (
  ...
  try {
    ...
    const result = await PasswordResetService.resetPasswordService(token, newPassword)
