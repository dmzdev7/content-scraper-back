...
import { sendPasswordChangedEmail, sendPasswordResetEmail } from '../../shared/utils/email.utils.js'
...
export const resetPasswordService = async (
  ...
  try {
    ...
    if (
      ...
      !['INVALID_RESET_TOKEN', 'RESET_TOKEN_EXPIRED', 'USER_INACTIVE'].includes(error.message)
    ) {
